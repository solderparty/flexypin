...
def generate(output, pitch, num):
    ...
    for i in range(num):
        ...
        r += s_expr(2, 'pad', '1', 'smd', 'custom',        at=[-0.90, i * pitch], size=[0.01, 0.01],                            layers=['F.Cu', 'F.Mask'], options=[s_expr(0, 'clearance', 'outline'), s_expr(0, 'anchor', 'rect')], primitives=s_expr(0, 'gr_poly', s_expr(0, 'pts', s_expr(0, 'xy', 0, 0), s_expr(0, 'xy', 0.35, 0.45), s_expr(0, 'xy', -0.5, 0.45), s_expr(0, 'xy', -0.5, -0.45), s_expr(0, 'xy', 0.35, -0.45)),       width=[0.00], fill=['yes'])) + '\n'
        r += s_expr(2, 'pad', '2', 'smd', 'custom',        at=[-0.90, i * pitch], size=[0.01, 0.01],                            layers=['B.Cu', 'B.Mask'], options=[s_expr(0, 'clearance', 'outline'), s_expr(0, 'anchor', 'rect')], primitives=s_expr(0, 'gr_poly', s_expr(0, 'pts', s_expr(0, 'xy', 0, 0), s_expr(0, 'xy', 0.35, 0.45), s_expr(0, 'xy', -0.5, 0.45), s_expr(0, 'xy', -0.5, -0.45), s_expr(0, 'xy', 0.35, -0.45)),       width=[0.00], fill=['yes'])) + '\n'
